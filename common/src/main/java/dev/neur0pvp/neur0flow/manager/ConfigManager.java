...
public class ConfigManager {
    ...
    public void loadConfig(boolean reloadConfig) {
        ...
        enableMessage = configWrapper.getString("messages.toggle.global.enable", "&aSuccessfully enabled neur0flow.");
        disableMessage = configWrapper.getString("messages.toggle.global.disable", "&cSuccessfully disabled neur0flow.");
        playerEnableMessage = configWrapper.getString("messages.toggle.player.enable", "&aSuccessfully enabled neur0flow for %player%.");
        playerDisableMessage = configWrapper.getString("messages.toggle.player.disable", "&aSuccessfully &cdisabled &aneur0flow for %player%.");
        playerIneligibleMessage = configWrapper.getString("messages.toggle.player.ineligible", "&c%player% is ineligible for neur0flow. If you believe this is in error, please contact your server administrators.");
